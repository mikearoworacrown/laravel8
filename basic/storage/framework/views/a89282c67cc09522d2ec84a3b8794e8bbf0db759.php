  ...
  <body class="bg-light-gray" id="body">
                  ...
                  <?php echo csrf_field(); ?>
                    <div class="row">
                      <div class="form-group col-md-12 mb-4">
                        <input type="email" class="form-control input-lg" id="email" name="email" aria-describedby="nameHelp" placeholder="Email" required>
                      </div>
                      <div class="form-group col-md-12 ">
                        <input type="password" class="form-control input-lg" id="password" placeholder="Password" required autocomplete="new-password">
                      </div>
                      <div class="form-group col-md-12 ">
          ...
          <div class="copyright pl-0">
            <p class="text-center">&copy; 2021 Copyright by
              <a class="text-primary" href="http://www.vastcrown.com/" target="_blank">Vastcrown</a>.
            </p>
          </div>
        </div>
</body>
</html><?php /**PATH /opt/lampp/htdocs/laravel8/basic/resources/views/auth/register.blade.php ENDPATH**/ ?>